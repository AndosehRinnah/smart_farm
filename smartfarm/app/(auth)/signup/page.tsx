...
import { Sprout, Lock, Mail, ArrowRight, AlertCircle, Eye, EyeOff, Wheat, BarChart3, Users, CheckCircle } from 'lucide-react';
import { motion } from 'framer-motion';
import Link from 'next/link';

const benefits = [
  { icon: Wheat, label: 'Track crops & fields in real time' },
  { icon: BarChart3, label: 'Monitor income & expenses (FCFA)' },
  { icon: Users, label: 'Assign tasks to your farm team' },
  { icon: CheckCircle, label: 'Low stock alerts & inventory control' },
];
    ...
    <div className="relative min-h-screen w-full flex bg-slate-950 font-sans text-slate-100 overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col items-start justify-between p-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <motion.div
            ...
            className="absolute top-[10%] right-[-5%] w-[420px] h-[420px] rounded-full bg-emerald-500/14 blur-[130px]"
          />
          <motion.div
            animate={{ scale: [1, 1.15, 0.9, 1], x: [0, 40, -20, 0], y: [0, -20, 30, 0] }}
            transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute bottom-[-5%] left-[-5%] w-[480px] h-[480px] rounded-full bg-teal-500/10 blur-[140px]"
          />
          <motion.div
            animate={{ scale: [1, 0.85, 1.1, 1] }}
            transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute top-[40%] right-[25%] w-[180px] h-[180px] rounded-full bg-indigo-400/8 blur-[70px]"
          />
        ...
        <div className="relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/25 text-emerald-400 text-xs font-bold mb-5 tracking-wide uppercase"
          >
          ...
          >
            Create your free account and get access to the complete SmartFarm platform — built for African agriculture.
          </motion.p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
        <div className="absolute inset-0 lg:hidden">
          <motion.div
            animate={{ scale: [1, 1.05, 0.9, 1], x: [0, -30, 20, 0], y: [0, 20, -40, 0] }}
            transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute top-[10%] right-[10%] w-[280px] h-[280px] rounded-full bg-emerald-500/10 blur-[90px]"
          />
          <motion.div
            animate={{ scale: [1, 1.1, 0.95, 1], x: [0, 40, -20, 0], y: [0, -20, 30, 0] }}
            transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute bottom-[10%] left-[10%] w-[320px] h-[320px] rounded-full bg-indigo-500/10 blur-[110px]"
          />
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm mt-1.5 font-medium">Join thousands of African farmers using SmartFarm</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    id="signup-password"
                  />
                  <button type="button" onClick={() => setShowPassword(v => !v)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-600 hover:text-slate-400 transition-colors cursor-pointer">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  />
                  <button type="button" onClick={() => setShowConfirm(v => !v)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-600 hover:text-slate-400 transition-colors cursor-pointer">
